...
# JSONファイルのパス
json_file_path = 'C:/Users/harut/fluid/campusOS/haruto/data.json'
...
def get_icon_path(condition):
    if condition >= 0.8:
        return 'C:/Users/harut/fluid/campusOS/haruto/153_000_000.png'     # condition>=80%:  赤(153, 0, 0)
    elif condition >= 0.6:
        return 'C:/Users/harut/fluid/campusOS/haruto/255_051_051.png'   # condition>=60%:  赤(255, 51, 51)
    elif condition >= 0.4:
        return 'C:/Users/harut/fluid/campusOS/haruto/255_153_153.png' # condition>=40%:  赤(255, 153, 153)
    else:
        return 'C:/Users/harut/fluid/campusOS/haruto/255_230_230.png' # condition>=0%:   赤(255, 230, 230)
